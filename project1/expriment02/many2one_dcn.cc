...
int main (int argc, char *argv[])
{
  ...
  csma[0].EnablePcap ("many2one_ser", devices[0].Get (1), true); //n1
  csma[0].EnablePcap ("many2one_tor", devices[0].Get (0), true); //t1
  csma[4].EnablePcap ("many2one_aggr", devices[4].Get (0), true); //a1
  ppp[0].EnablePcap ("many2one_core", p2pDevices[0].Get (0), true); //c1
